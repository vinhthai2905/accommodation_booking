...
from . import AuthLoginView, AuthLogoutView, FetchAuthUserView, RefreshAuthUserView
...
urlpatterns = [
    ...
    path('api/auth/user/fetch', FetchAuthUserView.as_view()),
    path('api/auth/user/refresh', RefreshAuthUserView.as_view()),
