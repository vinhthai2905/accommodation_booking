...
export default function DBHotelTypesPagination({ filteredHotelTypes }) {
    return (
        <div
            className={clsx(
        ...
        >
            <div className="flex items-center gap-2">
                <span>
                    Hiển thị 1-{Math.min(10, filteredHotelTypes.length)} trong số{" "}
                    {filteredHotelTypes.length}
                </span>
            ...
            <div className="flex items-center gap-1.5">
                ...
                <button
                    className={clsx(
                        ...
                        "rounded border border-blue-600 bg-blue-50",
