...
export default function DBHotelTypesToolBar({ 
    searchTerm, 
    setSearchTerm, 
}) {
    ...
    return (
        ...
        >
            ...
            <div className="flex w-full items-center justify-end gap-3 md:w-auto relative">
                <button 
                    onClick={() => navigate("/admin/dashboard/hotel-types/new")}
