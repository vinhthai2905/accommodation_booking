...
export default function DeleteHotelTypeModal({
    hotelType,
    setIsDeleteModalOpen,
    handleDeleteHotelType,
}) {
    return (
        <div
            className={clsx(
            ...
            >
                <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="mb-2 text-lg font-bold text-gray-900">
                        Xóa loại khách sạn này?
                    </h3>

                    <p className="mb-6 text-sm leading-relaxed text-gray-500">
                        Bạn có chắc chắn muốn xóa loại khách sạn{" "}
                        <strong className="font-semibold text-gray-900">
                            {hotelType.name}
                        </strong>
                        ? Thao tác này không thể hoàn tác và loại khách sạn sẽ bị gỡ khỏi hệ thống.
                    </p>
