...
export default function EditHotelTypeModal({
    setIsEditModalOpen,
    handleSaveHotelTypeEdit,
    editForm,
    setEditForm,
}) {
    return (
        ...
        >
            ...
            >
                ...
                {/* Form */}
                <form onSubmit={handleSaveHotelTypeEdit} className="space-y-4 p-6">
                    <div>
                        <label
                            className={clsx(
                                "mb-1.5 block",
