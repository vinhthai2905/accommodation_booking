...
import { 
    ...
    HelpCircle, Star, Heart, Activity, Dumbbell,
    Coffee, ShowerHead, Flame, Sofa, Wind, Check, Loader2,
    Search, X
} from "lucide-react"

import LoadingHotelDatas from "@/features/dashboard/partner/ui/dashboard-main/common/LoadingHotelDatas"
import { 
...
// Helper function to dynamically match amenities and categories to Lucide icons
...
export default function DBHotelAmenitiesSelection() {
    ...
    if (isLoadingCategories || isLoadingAvailable || isLoadingCurrent) {
        return <LoadingHotelDatas labelLoading="Đang tải thông tin tiện nghi khách sạn..." />
    }
    ...
    return (
        <div className="flex flex-col flex-1 w-full space-y-6">
            ...
            <motion.div
                ...
                className="p-6 md:p-8 rounded-2xl bg-gradient-to-r from-[#003b95] to-blue-700 text-white shadow-lg relative overflow-hidden"
            >
                        ...
                        {filteredCategories.map((cat) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-3 px-5 py-3 rounded-xl font-bold text-sm whitespace-nowrap cursor-pointer transition-all duration-300 relative border ${
                                        isActive
                                    ...
                                    >
                                        <div className="flex items-center gap-3.5 min-w-0">
                                            <div className={`p-3 rounded-xl transition-colors shrink-0 ${
                                                isChecked ? "bg-blue-100/70 text-[#003b95]" : "bg-gray-50 text-gray-500"
                                            }`}>
