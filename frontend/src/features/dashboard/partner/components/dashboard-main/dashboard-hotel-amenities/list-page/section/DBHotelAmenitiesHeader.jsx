...
export default function DBAmenitiesHeader({ motion }) {
    ...
    return (
        ...
        >
            <div className="flex flex-col items-start gap-2">
                ...
                <div>
                    <h1 className="mb-1 text-3xl font-bold text-gray-900">Danh sách tiện nghi</h1>
                    <p className="text-gray-500 text-sm">Quản lý các tiện nghi hiện có của khách sạn tại đây.</p>
                </div>
            </div>
        </motion.div>
    )
