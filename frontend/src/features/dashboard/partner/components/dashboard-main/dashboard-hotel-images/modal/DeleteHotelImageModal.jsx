...
export default function DeleteHotelImageModal({
    image,
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mb-6 text-sm leading-relaxed text-gray-500">
                        ...
                        <strong className="font-semibold text-gray-900">
                            {image?.image_name || "không tên"}
                        </strong>
                        ? Thao tác này không thể hoàn tác và hình ảnh sẽ bị gỡ khỏi hệ thống.
                    </p>
                    ...
                    <div className="flex w-full items-center justify-center gap-3">
                        ...
                        <button
                            ...
                            disabled={isPending}
                        >
                            {isPending ? "Đang xóa..." : "Xóa hình ảnh"}
                        </button>
                    </div>
                </div>
            </div>
