...
import DBHotelCategoryCreateHeader from "./DBHotelCategoryCreateHeader"
...
export default function DBCreateHotelCategory() {
    ...
    return (
        <div className="flex flex-col flex-1 w-full space-y-6">
            <DBHotelCategoryCreateHeader motion={motion} />
