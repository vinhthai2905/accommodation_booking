...
export default function DeleteHotelCategoryModal({
    category,
            ...
            >
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mb-6 text-sm leading-relaxed text-gray-500">
                        ...
                        ? Thao tác này không thể hoàn tác và các tiện nghi thuộc
                        danh mục này sẽ bị gỡ bỏ khỏi khách sạn.
                    </p>
