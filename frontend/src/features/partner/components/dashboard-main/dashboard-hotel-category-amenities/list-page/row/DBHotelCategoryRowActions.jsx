...
export default function DBHotelCategoryRowActions({ setIsMenuOpen, setIsDeleteModalOpen, category }) {
    ...
    return (
        <div className={clsx(
            ...
            <button
                onClick={() => {
                    setIsMenuOpen(false)
                    navigate(`/partner/dashboard/hotel/category-amenities/${category.id_amenity_category}`)
                }}
                className={clsx(
            ...
            <button
                onClick={() => {
                    setIsMenuOpen(false)
                    navigate(`/partner/dashboard/hotel/category-amenities/${category.id_amenity_category}/edit`)
                }}
                className={clsx(
                    "flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-xs font-semibold text-gray-700",
