...
export default function DBHotelCategoryAmenitiesHeader({ motion, categoryName }) {
        ...
        >
            <div>
                ...
                <h1 className="mb-1 text-3xl font-bold text-gray-900">
                    Chi tiết danh mục: <span className="text-blue-600">{categoryName || "..."}</span>
                </h1>
                <p className="text-gray-500 text-sm">Xem và quản lý danh sách các tiện nghi thuộc danh mục này.</p>
            </div>
        </motion.div>
    )
}
