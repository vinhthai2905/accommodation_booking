export default function DBHotelImageTableColumn() {
    return (
        <thead>
            <tr className="text-[13px] text-gray-500 border-b border-gray-200 bg-gray-50/50">
                ...
                <th className="p-4 font-medium whitespace-nowrap">Hình ảnh</th>
                <th className="p-4 font-medium whitespace-nowrap">Tên ảnh</th>
