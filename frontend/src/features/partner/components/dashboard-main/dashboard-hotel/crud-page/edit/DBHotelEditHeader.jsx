...
export default function DBHotelEditHeader({ motion, hotelName }) {
        ...
        >
            <div>
                ...
                <h1 className="mb-1 text-3xl font-bold text-gray-900 flex items-center gap-3">
                    Chỉnh sửa: <span className="text-blue-600">{hotelName || "Đang tải..."}</span>
                </h1>
                <p className="text-gray-500 text-sm">Cập nhật các thông tin cơ bản cho khách sạn.</p>
            </div>
        </motion.div>
    )
}
