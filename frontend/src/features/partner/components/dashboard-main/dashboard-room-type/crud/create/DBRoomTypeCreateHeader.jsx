    ...
    return (
        ...
        >
            <div>
                ...
                <h1 className="mb-1 text-3xl font-bold text-gray-900">Thêm loại phòng mới</h1>
                <p className="text-gray-500 text-sm">Điền thông tin bên dưới để tạo loại phòng mới cho khách sạn của bạn.</p>
            </div>
        </motion.div>
    )
}
